        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Step 1 of 6</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <p className="text-foreground leading-relaxed">
              The Y-BOCS is a clinician-administered scale designed to evaluate the severity and types of obsessive-compulsive symptoms experienced by the patient over the past week. Ratings are based on patient report, collateral input if applicable, and clinician clinical judgment.
            </p>
          </Card>
          ...
          <Card>
            ...
            <ul className="space-y-3 text-foreground">
              <li className="flex gap-3">
                ...
                <span>This is a semi-structured interview that assesses symptoms over the past week</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-semibold">•</span>
          ...
          <Card>
            <h2 className="text-xl font-semibold text-foreground mb-4">Identifying Target Symptoms</h2>
            <ul className="space-y-3 text-foreground">
              <li className="flex gap-3">
                <span className="text-accent font-semibold">•</span>
                <span>List all current obsessions and compulsions using the symptom checklist as a guide</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-semibold">•</span>
                <span>Distinguish between recent symptoms (past 30 days) and current symptoms (past week)</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-semibold">•</span>
                <span>Identify the most prominent symptoms that will guide the assessment</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-semibold">•</span>
                <span>Include avoidance behaviors that reduce functioning</span>
              </li>
            </ul>
          </Card>
